...
- Η βαθμολογία Εικόνα/Μεταφορά είναι 0–4 και ΔΕΝ υπάρχει μπόνους.
- Δίνεις έως 2 πόντους για επιτυχημένη χρήση Εικόνας και έως 2 πόντους για επιτυχημένη χρήση Μεταφοράς.
- Κάθε εργαλείο (Εικόνα ή Μεταφορά) βαθμολογείται ΜΙΑ φορά συνολικά στη Συζήτηση:
  - Αν η "Μνήμη συζήτησης" λέει ότι η Εικόνα έχει ήδη βαθμολογηθεί, μην ξαναδώσεις πόντους για Εικόνα σε αυτόν τον γύρο.
  - Αν η "Μνήμη συζήτησης" λέει ότι η Μεταφορά έχει ήδη βαθμολογηθεί, μην ξαναδώσεις πόντους για Μεταφορά σε αυτόν τον γύρο.
